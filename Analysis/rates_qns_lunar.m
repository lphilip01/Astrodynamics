function dxdt = rates_qns_lunar(t, x, params)
% rates_qns_lunar
%
% Near-circular quasi-nonsingular lunar third-body rates for Earth orbit.
%
% State:
...
%   params.muMoon     Moon gravitational parameter [km^3/s^2]
...
%   3) Moon position is obtained from planetEphemeris.
%
...
% Moon position wrt Earth in J2000/ICRF [km]
r_moon = planetEphemeris(jd, 'Earth', 'Moon', eph);
r_moon = r_moon(:);
...
% Exact lunar third-body differential acceleration [km/s^2]
rho = r_moon - r_sat;
a_3b = muMoon * ( rho/norm(rho)^3 - r_moon/norm(r_moon)^3 );
